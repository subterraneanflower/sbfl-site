...
!(function(d) {
  ...
  Object.keys(r).forEach(function(e) {
    ...
    /^\w+$/.test(e) || a.push(/\w+/.exec(e)[0]),
      'diff' === e && a.push('bold'),
      (d.languages.diff[e] = { pattern: RegExp('^(?:[' + n + '].*(?:\r\n?|\n|(?![\\s\\S])))+', 'm'), alias: a });
  }),
...
!(function(n) {
  ...
  (t.string[1].inside.interpolation.inside.rest = t),
    ...
    n.hooks.add('before-tokenize', function(e) {
      var t = RegExp(
        '<#--[\\s\\S]*?--\x3e|<\\/?[#@][a-zA-Z](?:<expr>)*?>|\\$\\{(?:<expr>)*?\\}'.replace(/<expr>/g, a),
        'gi'
      );
  ...
  var n = '(?:\\w+(?:<braces>)?|<braces>)'.replace(/<braces>/g, '\\((?:[^()]|\\((?:[^()]|\\([^()]*\\))*\\))*\\)'),
    i = (e.languages.pascaligo = {
      ...
      'class-name': [
        ...
        { pattern: RegExp('<type>(?=\\s+is\\b)'.replace(/<type>/g, n), 'i'), inside: null },
...
!(function(t) {
  ...
  function n(t, n) {
    ...
    return (
      (e.tag = { pattern: /([\r\n](?:  |\t)[ \t]*)\[[-\w]+\]/, lookbehind: !0, inside: { punctuation: /\[|\]/ } }),
      (e.variable = o),
      (e.comment = r),
      {
  ...
  e.languages.sas = {
    ...
    'proc-groovy': {
      ...
      inside: {
        groovy: {
          pattern: RegExp(
            '(^[ \t]*submit(?:\\s+(?:load|parseonly|norun))?)(?:<str>|[^"\'])+?(?=endsubmit;)'.replace(/<str>/g, t),
            'im'
          ),
          lookbehind: !0,
    ...
    'proc-cas': {
      ...
      inside: {
        ...
        'cas-actions': g,
        statement: { pattern: /((?:^|\s)=?)(?:default|(?:un)?set|on|output|upload)[^;]+/im, lookbehind: !0, inside: d },
        step: i,
        keyword: k,
        function: l,
        comment: s,
...
!(function(n) {
  var e = /\b(?:align|allowzero|and|asm|async|await|break|cancel|catch|comptime|const|continue|defer|else|enum|errdefer|error|export|extern|fn|for|if|inline|linksection|nakedcc|noalias|null|or|orelse|packed|promise|pub|resume|return|stdcallcc|struct|suspend|switch|test|threadlocal|try|undefined|union|unreachable|usingnamespace|var|volatile|while)\b/,
    ...
    s =
      ...
      '\\s*)*' +
      '(?:\\bpromise\\b|(?:\\berror\\.)?<ID>(?:\\.<ID>)*(?!\\s+<ID>))'.replace(/<ID>/g, a) +
      ')+';
  (n.languages.zig = {
