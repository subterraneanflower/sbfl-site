...
"%":"DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGRect|WebGLBuffer|WebGLProgram|WebGLShader|WebGLUniformLocation"},
kn:{
"^":"Gv;",
...
z=this.Jd
if(z!=null)z.V1(0)
for(z=this.Gx,y=z.gCP(z),x=y.Hb,y=H.VM(new H.MH(null,x.gA(x),y.Oh),[H.Kp(y,0),H.Kp(y,1)]);y.G();)y.Ff.AN()
if(z.X5>0){z.Nz=null
z.HH=null
z.Cs=null
z.cG=null
...
z.e=null
y=new P.VN(z,b)
for(x=new H.a7(a,2,0,null);x.G();)x.Ff.Rx(new P.ff(z,b,z.c++),y)
y=z.c
...
z.Nk(a,b)},function(a){return this.w0(a,null)},"pm","$2","$1","gYJ",2,2,13,14]},
vs:{
...
if((b.YM===2?null:b.Nw)!=null)new P.DG(z,x,w,b,r).$0()
if(q!=null)$.X3=q
b.hO=null
b.kO=null
b.bv=null
...
gx:function(a){return this.Ev[0]},
gy:function(a){return this.Ev[1]},
gz:function(a){return this.Ev[2]}}}],["","",,D,{
"^":"",
Iq:[function(){P.pH([W.Kn("vertex_shader.glsl",null,null),W.Kn("fragment_shader.glsl",null,null)],!1).ml(new D.em())},"$0","eE",0,0,1],
YT:function(a,b){var z,y,x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h,g,f,e
z={}
...
x=J.YP(y)
J.N6(x,0,0,512,512)
w=x.createShader(35633)
x.shaderSource(w,a)
x.compileShader(w)
v=x.createShader(35632)
x.shaderSource(v,b)
x.compileShader(v)
if(x.getShaderParameter(w,35713)!==!0)throw H.b(P.FM("Failed to compile vertex shader: "+H.d(x.getShaderInfoLog(w))))
if(x.getShaderParameter(v,35713)!==!0)throw H.b(P.FM("Failed to compile fragment shader: "+H.d(x.getShaderInfoLog(v))))
u=x.createProgram()
x.attachShader(u,w)
x.attachShader(u,v)
x.linkProgram(u)
if(x.getProgramParameter(u,35714)!==!0)throw H.b(P.FM("Failed to link program: "+H.d(x.getProgramInfoLog(u))))
x.useProgram(u)
x.enable(2929)
t=new Float32Array(16)
new T.aI(t).xI()
s=Math.tan(0.5235987755982988)*30
r=-s
...
n[8]=o
n[9]=o
n[10]=-1.2222222222222223
n[11]=-1
n[14]=-66.66666666666667
m=x.getUniformLocation(u,"model")
l=x.getUniformLocation(u,"view")
k=x.getUniformLocation(u,"projection")
x.uniformMatrix4fv(m,!1,t)
x.uniformMatrix4fv(k,!1,q)
j=x.createBuffer()
i=x.createBuffer()
x.bindBuffer(34962,j)
h=x.getAttribLocation(u,"vertexPosition")
g=x.getAttribLocation(u,"color")
x.enableVertexAttribArray(h)
x.enableVertexAttribArray(g)
x.vertexAttribPointer(h,3,5126,!1,24,0)
x.vertexAttribPointer(g,3,5126,!1,24,12)
f=new Float32Array(H.XF(H.VM([-30,30,0,0,1,0,-30,-30,0,1,0,0,30,30,0,1,0,0,30,-30,0,0,0,1],[P.CP])))
e=new Uint16Array(H.XF(H.VM([0,1,2,1,3,2],[P.KN])))
x.bindBuffer(34962,j)
x.bufferData(34962,f,35044)
x.bindBuffer(34963,i)
x.bufferData(34963,e,35044)
z.a=0
q=window
C.ol.y4(q)
C.ol.ne(q,W.aF(new D.ck(z,x,l,e,100)))},
em:{
"^":"Tp:8;",
$1:function(a){var z=J.U6(a)
return D.YT(z.t(a,0),z.t(a,1))}},
ck:{
"^":"Tp:22;a,b,c,d,e",
$1:function(a){var z,y,x,w,v,u,t,s,r,q,p,o,n,m,l,k
z=this.a
y=z.a+=0.017453292519943295
y=Math.sin(y)
x=this.e
z=z.a
z=Math.cos(z)
w=new Float32Array(3)
new T.An(w).PJ(y*x,100,z*x)
z=new Float32Array(3)
...
y[14]=k.gz(k)
x=this.b
x.uniformMatrix4fv(this.c,!1,y)
x.clear(16640)
x.drawElements(4,this.d.length,5123,0)
x=window
C.ol.y4(x)
C.ol.ne(x,W.aF(this))}}},1],])
...
init.metadata=[{func:"n9",void:true,args:[{func:"X0",void:true}]},{func:"X0",void:true},{func:"Ib",ret:P.a2,args:[null,null]},{func:"bX",ret:P.KN,args:[null]},{func:"E0",ret:P.a2,args:[P.a,P.a]},{func:"ZY",ret:P.KN,args:[P.a]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,P.qU]},{func:"uO",args:[P.qU]},{func:"xO",args:[{func:"X0",void:true}]},{func:"rf",args:[P.a]},{func:"Ns",void:true,args:[P.a],opt:[P.mE]},,{func:"Vx",void:true,args:[null],opt:[P.mE]},{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:P.a2},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:P.qU,args:[P.KN]},{func:"Za",args:[P.qU,null]},{func:"Xd",void:true,args:[P.CP]},];$=null
